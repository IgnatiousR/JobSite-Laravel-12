    ...
    <section class="flex flex-col md:flex-row gap-4">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full">
            ...
            <form method="POST" action="{{route('profile.update')}}" enctype="multipart/form-data">
                ...
                {{-- <x-inputs.text id="password" name="password" label="Email address" type="email" value="{{$user->email}}" /> --}}
        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full">
            ...
            <div class="flex justify-between items-center border-b-2 border-gray-200 py-2">
                ...
                <div class="flex space-x-3">
                    ...
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="px-4 py-2 bg-red-500 hover:bg-red-600 cursor-pointer text-white rounded text-sm">
                        Delete
                    </button>
                    </form>
                    <!-- End Delete Form -->
            ...
            <div class="mt-4 bg-gray-100 p-2 rounded">
                <h4 class="text-lg font-semibold mb-2 pl-2">Applicants</h4>
                ...
                <div class="py-2">
                    ...
                    <form method="POST" action="{{route('applicant.destroy', $applicant->id)}}"
                        ...
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="text-red-500 hover:text-red-700 text-sm cursor-pointer hover:underline">
                        <i class="fas fa-trash"></i> Delete Applicant
                        </button>
                    </form>
                </div>
                @empty
                <p class="text-gray-700 mb-5 pl-2">No applicants for this job</p>
                @endforelse
            </div>
            @empty
