<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
      ...
      <form method="POST" action="{{route('jobs.store')}}" enctype="multipart/form-data">
        ...
        <x-inputs.text-area id="requirements" name="requirements" label="Requirements (Optional)"
          placeholder="Bachelor's degree in Computer Science" />

        <x-inputs.text-area id="benefits" name="benefits" label="Benefits (Optional)"
        ...
        <x-inputs.text id="company_website" name="company_website" label="Company Website (Optional)" type="url"
          placeholder="Enter Company Website" />

        <x-inputs.text id="contact_phone" name="contact_phone" label="Contact Phone (Optional)" placeholder="Enter Contact Phone" />

        <x-inputs.text id="contact_email" name="contact_email" label="Contact Email" placeholder="Enter Contact Email"
          type="email" />

        <x-inputs.file id="company_logo" name="company_logo" label="Company Logo (Optional)" />
